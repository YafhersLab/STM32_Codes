...
int main(void){
	...
	//adress set (depende de tu tipo de ethernet)
	uint8_t temp = IK_DEST_UNREACH;
	uint8_t W5x00_AdrSet[2][4] = {{2,2,2,2},{2,2,2,2}};	//RX 2kb 2kb 2kb 2kb = 8kb, TX
	if(ctlwizchip(CW_INIT_WIZCHIP, (void*)W5x00_AdrSet) == -1){
		printf("Error en inicializar el buffer del ethernet");
	}
